...
$saldoAposBaixa = (Invoke-RestMethod "$api/estoques" | Where-Object produtoId -eq $produto.id).quantidade
...
$saldoAposEstorno = (Invoke-RestMethod "$api/estoques" | Where-Object produtoId -eq $produto.id).quantidade
